...
const questions = [

  {
    ...
    validate: (answer) => {
      if (answer) {return true} else {return 'Please enter a title, to continue'}}
  },
  {
    type: 'input',
  ...
  },
  {
    ...
    name: 'installation',
    validate: (answer) => {
      if (answer) {return true} else {return 'Please provide installation steps, to continue'}}
  },
  {
    type: 'input',
    ...
    name: 'usage',
    validate: (answer) => {
      if (answer) {return true} else {return 'Please provide usage instructions to continue'}}
  },
  {
    type: 'input',
    ...
    name: 'tests',
    validate: (answer) => {
      if (answer) {return true} else {return 'Please provide tests if any to continue'}}
  },
  {
    type: 'input',
  ...
  },
  {
    ...
    name: 'username',
    validate: (answer) => {
      if (answer) {return true} else {return 'Please provide a GitHub username to continue'}}
  },
  {
    type: 'input',
    ...
    name: 'email',
    validate: (answer) => {
      if (answer) {return true} else {return 'Please enter an email address, to continue'}}
  }
]
